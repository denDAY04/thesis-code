...
class SecureVaultTest {
    ...
    void buildFromFragments() throws IOException, ClassNotFoundException {
        ...
        SecureVault vault = Assertions.assertDoesNotThrow(() -> vaultBuilder.build(), "Valid vault build throws exception");
    ...
    void addFragment() {
        ...
        Assertions.assertDoesNotThrow(() ->vaultBuilder.addFragment(f1), "Adding valid fragment threw exception");
    }
